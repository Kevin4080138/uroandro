...
const HARAKATLAR = [
  ...
  {
    belgi: '📝',
    sarlavha: "O'z-o'zini tekshirish",
    izoh: "Belgilaringiz bo'yicha dastlabki baholash",
    href: '/patient/oz-tekshiruv',
    asosiy: false,
    ochiq: true,
  },
  {
    belgi: '🧪',
    sarlavha: 'Qaysi tahlil kerak?',
    izoh: 'Shikoyatingizga mos tekshiruvlar ro\'yxati',
    href: '/patient/qaysi-tahlil',
    asosiy: false,
    ochiq: true,
  },
  {
    belgi: '❓',
    sarlavha: "Ko'p so'raladigan savollar",
    izoh: 'Urologiya bo\'yicha keng tarqalgan savollar',
    href: '/patient/savollar',
    asosiy: false,
    ochiq: true,
  },
  {
  ...
  },
  {
    belgi: '💊',
    sarlavha: 'Dorilarim',
    izoh: 'Retsept va dori qabul qilish eslatmalari',
