...
export const GINEKOLOGIYA_KALKULYATORLARI: GinekologiyaKalkulyatori[] = [
  ...
  { slug: 'preeklampsiya-xavfi', icon: '🫀', title: 'Preeklampsiya xavfini baholash', kategoriya: 'Homiladorlik', holat: 'malumot' },
  { slug: 'rcog-obstetrik-vte', icon: '🩸', title: 'Homiladorlik va puerperiyda VTE xavfi (RCOG)', kategoriya: 'Homiladorlik', holat: 'malumot' },
