    ...
    savollarBanki: [
      {
        ...
        variantlar: ["Prostata bezining saratonli o'sishi", "Prostataning xavfsiz, saraton bo'lmagan o'sishi", "Prostata bezining atrofiyasi", "Prostata bezining yallig'lanishi"],
        togri: 1,
      ...
      {
        savol: "McNeal tizimiga ko'ra prostata nechtа anatomik zonaga bo'linadi?",
      ...
      {
        savol: "BPH rivojlanishi uchun qaysi ikki shart zarur?",
        variantlar: ["Infeksiya va yosh", "Funksional moyaklar (androgen) va yosh", "Semizlik va diabet", "Gipertoniya va chekish"],
        togri: 1,
      ...
      {
        savol: "BPH patogenezida asosiy rol o'ynaydigan gormаn qaysi?",
        variantlar: ["Testosteron", "Dihidrotestosteron (DHT)", "Estrogen", "Kortizol"],
        togri: 1,
      ...
      },
      {
        ...
        variantlar: ["Qovuq mushaklarini bo'shashtiradi", "Prostata qon ta'minini kamaytiradi", "DHT sintezini bloklaydi va prostata hajmini kamaytiradi", "Siydik hosil bo'lishini kamaytiradi"],
        togri: 2,
      ...
      },
      {
        ...
        variantlar: ["α₁-retseptorlar orqali uretraga ta'sir qiladi", "Kattalashgan to'qima uretraga bevosita bosim o'tkazadi", "Qovuq mushaklarini zaiflаshtiradi", "Siydik ishlab chiqarishni oshiradi"],
        togri: 1,
      ...
      {
        savol: "BPH ning dinamik komponenti qanday mexanizm orqali ishlaydi?",
        variantlar: ["To'qima uretraga bosim o'tkazadi", "Qovuq hajmini kichraytiradi", "Prostata va qovuq bo'yni silliq mushaklaridagi α₁-adrenergik retseptorlar faollаshadi", "Buyrak filtratsiyasini kamaytiradi"],
        togri: 2,
        izoh: "Dinamik komponent — prostata va qovuq bo'yni silliq mushaklaridagi α₁-adrenergik retseptorlarning faollashishi. Bu komponentga α-blokerlar ta'sir qiladi.",
      },
      {
        savol: "LUTS — Lower Urinary Tract Symptoms — nima?",
        variantlar: ["Buyrak kasalligi belgilari", "Quyi siydik yo'llari simptomlari majmuasi", "Prostata saratori belgilari", "Siydik yo'li infeksiyasi belgilari"],
        togri: 1,
        izoh: "LUTS — Lower Urinary Tract Symptoms — quyi siydik yo'llari simptomlarining majmuasi. BPHda ko'p uchraydi, lekin sabab har doim BPH bo'lavermaydi.",
      },
      {
        savol: "BPH obstruktiv belgilari qaysilar?",
        variantlar: ["Tez-tez siyish, shoshilinch istak, tunda siyish", "Siydik oqimi zaifligi, hesitancy, zo'riqish, to'liq bo'shamaslik hissi", "Siydikda qon, og'riq, isitma", "Bel og'rig'i, ko'ngil aynishi, qayt qilish"],
        togri: 1,
        izoh: "Obstruktiv belgilar: siydik oqimi zaifligi, boshlanish kechikishi (hesitancy), zo'riqish (straining), kesik-kesik chiqish, to'liq bo'shamaslik hissi — bularning sababi uretraga mexanik bosim.",
      },
      {
        savol: "BPH irritativ belgilari qaysilar?",
        variantlar: ["Siydik oqimi zaifligi va hesitancy", "Siydikda qon va og'riq", "Tez-tez siyish, shoshilinch istak, nocturia (tunda siyish)", "Bel og'rig'i va isitma"],
        togri: 2,
        izoh: "Irritativ belgilar: tez-tez siyish (frequency), shoshilinch istak (urgency), tunda siyish (nocturia), shoshilinch tutolmaslik — bu qovuqning ikkilamchi o'zgarishi (detruzor giperaqtivligi) natijasi.",
      },
      {
        savol: "IPSS (Xalqaro prostata simptom balli) nechtа savoldan iborat va ballar diapazoni qanday?",
      ...
      },
      {
        ...
        variantlar: ["Og'ir daraja", "O'rtacha daraja", "Yengil daraja", "Juda og'ir daraja"],
        togri: 2,
        izoh: "IPSS: 0–7 yengil (watchful waiting), 8–19 o'rtacha (dori ko'rib chiqiladi), 20–35 og'ir (dori yoki jarrohlik ko'rsatiladi).",
      },
      {
        savol: "IPSS bo'yicha 8–19 ball qanday taktikani ko'rsatadi?",
        variantlar: ["Faqat kuzatuv (watchful waiting)", "Dori davolash ko'rib chiqiladi", "Darhol jarrohlik zarur", "Faqat hayot tarzi o'zgarishlari kifoya"],
        togri: 1,
        izoh: "IPSS 8–19 — o'rtacha daraja. Dori davolash (α-bloker va/yoki 5α-RI) ko'rib chiqiladi. Simptom bezovtalilik darajasiga ham qaraladi.",
      },
      {
        savol: "IPSS anketasida 7 ta simptom savolidan tashqari yana qanday savol beriladi?",
        variantlar: ["Yoshingiz nechanchi?", "Hayot sifati savoli — hozirgi holatingiz qanchalik bezovta qiladi?", "Dori istaringiz bormi?", "Uyda kimlar bor?"],
        togri: 1,
        izoh: "IPSS da qo'shimcha 'Hayot sifati' savoli beriladi: 'Agar qolgan umringizni hozirgi siydik holatida o'tkazsangiz qanday his qilasiz?' — bu davolash zarurligi haqida muhim ma'lumot beradi.",
      },
      {
        savol: "BPH da o'tkir siydik ushlanishi (AUR) qanday holat?",
        variantlar: ["Siydik haddan ko'p chiqishi", "To'satdan siydik chiqara olmaslik — shoshilinch kateterizatsiyani talab qiladi", "Siydikda qon paydo bo'lishi", "Siydik rangining o'zgarishi"],
        togri: 1,
      ...
      {
        savol: "BPH da jarrohlik uchun mutlaq ko'rsatmalar qaysilar?",
        variantlar: ["IPSS ≥8 va bemorning istagi", "AUR, buyrak yetishmovchiligi, qovuq toshlari, takroriy UTI, davolanmagan gematuriya", "Dori 1 oydan ko'p ichilgan bo'lsa", "PSA 2 dan oshganda"],
        togri: 1,
        izoh: "Mutlaq jarrohlik ko'rsatmalari: o'tkir siydik ushlanishi (AUR), BPH tufayli buyrak yetishmovchiligi, qovuq toshlari, qayta uchraydigan UTI, davolanmagan gematuriya.",
      },
      {
        savol: "BPH da Periferik zona (PZ) haqida qaysi bayonot to'g'ri?",
        variantlar: ["Bu yerdan BPH rivojlanadi", "Bu yorda saraton rivojlanadi (70–80%)", "Bu zona bezlarsiz", "Bu zonada ejaculatory duct o'tadi"],
        togri: 1,
      ...
      {
        savol: "α₁-blokerlar BPH davolashda nima uchun qo'llaniladi?",
        variantlar: ["Prostata hajmini kamaytirish uchun", "AUR xavfini uzoq muddatda kamaytirish uchun", "Prostata va qovuq bo'yni silliq mushaklarini bo'shashtirish uchun", "PSA darajasini kamaytirish uchun"],
        togri: 2,
      ...
      },
      {
        ...
        variantlar: ["Ikkalasi ham prostata hajmini kamaytiradi", "α-bloker tez ta'sir qiladi, 5α-RI esa prostata hajmini kamaytiradi (6 oyda)", "5α-RI tez ta'sir qiladi, α-bloker sekin", "Ikkalasi ham faqat katta prostatada samarali"],
        togri: 1,
        izoh: "α-blokerlar 2–4 haftada simptomni yaxshilaydi, hajmni o'zgartirmaydi. 5α-RI (finasterid) to'liq samara 6 oyda ko'rinadi, prostata hajmini ~25% kamaytiradi — lekin faqat katta prostata (>40 ml)da samarali.",
      },
      {
        savol: "BOO (Bladder Outlet Obstruction) qanday tashxis?",
        variantlar: ["Gistologik tashxis", "Klinik tashxis", "Urodinamik tashxis", "Radiolojik tashxis"],
        togri: 2,
      ...
      {
        savol: "TURP BPH jarrohligida qanday rol o'ynaydi?",
        variantlar: ["Minimal invaziv usul", "BPH davolashning jarrohlik 'oltin standarti'", "Faqat katta prostata (>80 ml) uchun", "Faqat yoshlarda qo'llaniladi"],
        togri: 1,
      ...
      {
        savol: "Uroflowmetriyada Qmax qiymati qancha bo'lsa kuchli to'siqlanish belgisi?",
        variantlar: [">25 ml/s", ">15 ml/s", "<10 ml/s", "<5 ml/s"],
        togri: 2,
      ...
      {
        savol: "BPH diagnostikasida PSA nima uchun o'lchanadi?",
        variantlar: ["Buyrak funksiyasini baholash uchun", "Infeksiyani aniqlash uchun", "Prostata saratorini istisno qilish va prostata hajmini baholash uchun", "Qon bosimini baholash uchun"],
        togri: 2,
      ...
      {
        savol: "Katta prostata (>40 ml) da PSA 2–4 ng/ml bo'lsa bu ko'pincha nimani anglatadi?",
        variantlar: ["Saraton ehtimoli yuqori", "BPH ga xos ko'rsatkich, saraton emas", "Infeksiya belgisi", "Darhol biopat talab qilinadi"],
        togri: 1,
        izoh: "Katta prostata (>40 ml) da PSA 2–4 ng/ml — bu ko'pincha BPH. Chunki har 1 ml to'qima ~0.1 ng/ml PSA qo'shadi. Ammo PSA o'sishi va erkin/umumiy PSA nisbati saratonni farqlashda yordam beradi.",
      },
      {
        savol: "PVR o'lchash BPH diagnostikasida nima uchun zarur?",
        variantlar: ["Infeksiyani aniqlash uchun", "Prostata hajmini aniqlash uchun", "Siydik chiqargandan keyin qovuqda qolgan siydik miqdorini aniqlash uchun", "PSA darajasini baholash uchun"],
        togri: 2,
        izoh: "PVR (post-void residual) — siydik chiqargandan keyin qovuqda qolgan siydik hajmi. Ko'p PVR qovuq detruzori toliqishini va surunkali siydik ushlanishi xavfini ko'rsatadi.",
      },
      {
        savol: "BPH da IPSS ≤7 bo'lganda qanday taktika tavsiya etiladi?",
        variantlar: ["Darhol jarrohlik", "Dori davolash boshlash", "Kuzatuv (watchful waiting) va hayot tarzi o'zgarishlari", "Darhol TURP"],
        togri: 2,
      ...
      {
        savol: "Finasterid BPH davolashda qancha vaqtda to'liq samara beradi?",
        variantlar: ["2–4 haftada", "1–2 oyda", "6 oyda", "2 yildan keyin"],
        togri: 2,
      ...
      {
        savol: "UroLift qanday minimal invaziv usul?",
        variantlar: ["Prostata to'qimasiga bug' injeksiyasi", "Prostataga ko'taruvchi implant qo'yish", "Uretrani kengaytiruvchi stent", "Lazer bilan to'qimani olib tashlash"],
        togri: 1,
        izoh: "UroLift — prostataga ko'taruvchi implant qo'yish orqali uretraga bosiladigan prostata to'qimasini chekkaga tortib ushlab turadigan minimal invaziv usul.",
      },
      {
        savol: "TRUS (transrektal ultratovush) BPH da nima uchun qo'llaniladi?",
        variantlar: ["Infeksiyani aniqlash uchun", "Buyrak funksiyasini baholash uchun", "Prostata hajmini aniq o'lchash va jarrohlik usulini tanlash uchun", "PSA darajasini aniqlash uchun"],
        togri: 2,
        izoh: "TRUS prostata hajmini aniq o'lchashda qo'llaniladi. Bu jarrohlik usulini tanlashda muhim — masalan, juda katta prostata (>80–100 ml) da oddiy prostatektomiya ko'rsatilishi mumkin.",
      },
      {
        savol: "BPH tufayli yuqori siydik yo'li shikastlanishi qanday namoyon bo'ladi?",
        variantlar: ["Siydikda qon va og'riq", "Ikki tomonlama gidronefroz va buyrak yetishmovchiligi", "Faqat tez-tez siyish", "Prostata og'rig'i"],
        togri: 1,
      ...
      {
        savol: "BPH da qovuq toshlarining hosil bo'lish mexanizmi nima?",
        variantlar: ["Kalsiy almashinuvining buzilishi", "Qovuqda turg'un siydik fond ta'sirida mineral kristallanishi", "Buyrak toshlarining siydik yo'li orqali tushishi", "Infeksiya natijasida to'qima kaltsifikatsiyasi"],
        togri: 1,
      ...
      {
        savol: "Hesitancy (boshlanish kechikishi) simptomi BPH ning qaysi guruhiga kiradi?",
        variantlar: ["Irritativ belgilar guruhiga", "Obstruktiv belgilar guruhiga", "Neyrogen belgilar guruhiga", "Infeksion belgilar guruhiga"],
        togri: 1,
      ...
      {
        savol: "Nocturia (tunda siyish) BPH ning qaysi belgilar guruhiga kiradi?",
      ...
      {
        savol: "BPH davolashda kombinatsiya terapiya (α-bloker + 5α-RI) qachon tavsiya etiladi?",
        variantlar: ["Barcha BPH bemorlarda", "IPSS ≤7 bo'lganda", "Katta prostata (>40 ml) va o'rtacha-og'ir simptomlar bo'lganda", "Faqat yoshlarda"],
        togri: 2,
      ...
      },
      {
        ...
        variantlar: ["Har bir BPH bemorida majburiy", "Qovuq toshlarini ko'rish va uretrani baholash zarur bo'lganda", "PSA oshgan barcha holatlarda", "IPSS ≥8 barcha bemorlarda"],
        togri: 1,
      ...
      },
      {
        ...
        variantlar: ["Prostata hajmini aniqlash uchun", "Infeksiya, gematuriya va glyukozuriyani istisno qilish uchun", "PSA darajasini aniqlash uchun", "Buyrak ultratovushiga alternativa sifatida"],
        togri: 1,
      ...
      {
        savol: "BPH da gematuriyani davolashda finasterid qanday rol o'ynaydi?",
        variantlar: ["Gematuriyaga ta'sir qilmaydi", "Qovuq qon tomirlarini kengaytiradi", "Prostata qon tomirlarini qisqartirib, gematuriyani 90% da davolaydi", "Faqat infeksion gematuriyani davolaydi"],
        togri: 2,
